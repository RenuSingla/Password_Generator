      ...
      <form className="generator__form">
        <div className="generator__form-controls">
          ...
          <div className="generator__form-control">
            ...
            <input
            checked={isLowercase}
             onChange={(e) => setIsLowercase(e.target.checked)} type="checkbox" id="lowercase" name="lowercase"/>
          </div>
          ...
          <div className="generator__form-control">
            ...
            <input
            checked={isNumber}
             onChange={(e) => setIsNumber(e.target.checked)} type="checkbox" id="numbers" name="numbers"/>
          </div>
          ...
          <div className="generator__form-control">
            ...
            <input 
            checked={isSymbol}
             onChange={(e) => setIsSymbol(e.target.checked)}type="checkbox" id="symbols" name="symbols"/>
          </div>
